...
public class DemoLL02_04 {
	...
	public static void main(String[] args) {
		...
		DisplayLL(last);
		/*
		 * myList01.nextNode = new Node("Carol"); last = myList01.nextNode;
		 */
		...
		DisplayLL(last);
		/*
		 * myList01.nextNode.nextNode = new Node("Debby"); last =
		 * myList01.nextNode.nextNode;
		 */
		...
		DisplayLL(last);
		/*
		 * myList01.nextNode.nextNode.nextNode = new Node("Ellen"); last =
		 * myList01.nextNode.nextNode.nextNode;
		 */
		...
		int test1 =0;
		test1 = GreaterThanLL(head, "Dx");
		//System.out.println("The value was fount at position " + test1);
