...
/**
 * Figure 18-9 MOD This program stores Car objects in a HashSet and then
...
public class CarHashSet {
	public static void main(String[] args) {
		...
		for (Car c : carSet) {
			System.out.print("Hashcode is: " + c.getVin().hashCode() + "  ");
		...
		System.out.print("Hashcode is: " + mustang.getVin().hashCode() + "  ");
		...
		System.out.print("Hashcode is: " + plymouth.getVin().hashCode() + "  ");
