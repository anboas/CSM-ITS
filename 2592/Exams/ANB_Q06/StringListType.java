...
/**
 * The StringListType class is a concrete class for storing an unordered list of
 * String objects.
 */
...
public class StringListType implements StringList {
	 ...
	 *                if the specified capacity is less than one.
	 */
	...
	/**
	 * Replace the string at a specified index with another string.
	 * 
	 * @param index
