...
/**
 * The StringList interface specifies the operations that should be supported by
 * a list of strings.
 */
...
public interface StringList {
	...
	/**
	 * The indexOf method gets the index of the first occurrence of the
	 * specified string.
	 * 
	 * @param str
	 *            The string to search for.
	 * @return The index of the first occurrence of str if it exists; -1 if str
	 *         is not in the list.
	 */
	...
	/**
	 * The remove method remove a specific string from the list.
	 * 
	 * @param str
	...
	/**
	 * The set method replaces the string at a specified index with another
	 * string.
	 * 
	 * @param index
	 *            The index of the string to replace.
	 * @param str
